...
import {
  ...
  themes,
  useTheme
} from "./chunk-VGXD5H4V.js";
import {
  require_preview_api
} from "./chunk-UHEOKETK.js";
import {
  require_preview_api as require_preview_api2
} from "./chunk-XUQHJTRW.js";
import {
  require_client_logger
} from "./chunk-KTZIZTWB.js";
import {
  SNIPPET_RENDERED,
  SourceType
} from "./chunk-GL5UCGF7.js";
import {
  require_react_dom
} from "./chunk-AAAZ6LTA.js";
import {
  useMDXComponents
} from "./chunk-RJOGUQW4.js";
import {
  require_react
} from "./chunk-KO34Y52M.js";
import {
  __toESM
...
var LazyColorControl = (0, import_react6.lazy)(() => import("./Color-FRDS63T2-GY5HWEMF.js"));
...
var DocsContext = globalThis ? globalThis.__DOCS_CONTEXT__ : (0, import_react50.createContext)(null);
...
var StoryImpl = (props = { __forceInitialArgs: false, __primary: false }) => {
  let context = (0, import_react51.useContext)(DocsContext), storyId = getStoryId(props, context), story = useStory(storyId, context);
  if (!story)
...
var Preview = ({
  ...
  let [expanded, setExpanded] = (0, import_react27.useState)(isExpanded), [copied, setCopied] = (0, import_react27.useState)(null), [scale, setScale] = (0, import_react27.useState)(1), additionalActionItems = (0, import_react27.useMemo)(
    ...
    [additionalActions]
  ), sourceId = $bdb11010cef70236$export$f680877a34711e37(), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), context = (0, import_react27.useContext)(DocsContext), copyToClipboard = (0, import_react27.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./components-T6ODK7VT.js");
    ...
    try {
      ...
      import_client_logger5.logger.error(err), setCopied("Copy error!");
    }
...
var useOf = (moduleExportOrType, validTypes) => (0, import_react66.useContext)(DocsContext).resolveOf(moduleExportOrType, validTypes);
...
var SourceImpl = (props) => {
  let sourceContext = (0, import_react68.useContext)(SourceContext), docsContext = (0, import_react68.useContext)(DocsContext), sourceProps = useSourceProps(props, docsContext, sourceContext);
...
var CanvasImpl = (props) => {
  ...
  let docsContext = (0, import_react67.useContext)(DocsContext), sourceContext = (0, import_react67.useContext)(SourceContext), { of, source } = props;
  if ("of" in props && of === void 0)
    throw new Error("Unexpected `of={undefined}`, did you mistype a CSF file reference?");
...
var usePrimaryStory = () => (0, import_react74.useContext)(DocsContext).componentStories().find((story) => story.tags.includes(import_preview_api3.Tag.AUTODOCS));
...
var ControlsImpl = (props) => {
  var _a;
  let { of } = props, context = (0, import_react71.useContext)(DocsContext), primaryStory = usePrimaryStory(), story = of ? context.resolveOf(of, ["story"]).story : primaryStory;
  if (!story)
    return null;
...
var AddContext = (props) => {
  let { children, ...rest } = props, parentContext = import_react77.default.useContext(DocsContext);
  return import_react77.default.createElement(DocsContext.Provider, { value: { ...parentContext, ...rest } }, children);
};
var CodeOrSourceMdx = ({
  className,
  children,
...
var AnchorInPage = ({ hash, children }) => {
  let context = (0, import_react77.useContext)(DocsContext);
  return import_react77.default.createElement(
    A2,
    {
      href: hash,
...
var AnchorMdx = (props) => {
  let { href, target, children, ...rest } = props, context = (0, import_react77.useContext)(DocsContext);
...
var HeaderWithOcticonAnchor = ({
  ...
  let context = (0, import_react77.useContext)(DocsContext), OcticonHeader = OcticonHeaders[as], hash = `#${id}`;
...
var DocsContainer = ({
  ...
  }), import_react79.default.createElement(DocsContext.Provider, { value: context }, import_react79.default.createElement(SourceContainer, { channel: context.channel }, import_react79.default.createElement(ThemeProvider, { theme: ensure(theme) }, import_react79.default.createElement(
    DocsPageWrapper,
    {
...
var StoriesImpl = ({ title = "Stories", includePrimary = true }) => {
  var _a;
  let { componentStories, projectAnnotations, getStoryContext } = (0, import_react85.useContext)(DocsContext), stories = componentStories(), { stories: { filter } = { filter: void 0 } } = ((_a = projectAnnotations.parameters) == null ? void 0 : _a.docs) || {};
...
var SubtitleImpl = (props) => {
  ...
  componentSubtitle && (0, import_client_logger6.deprecate)(
...
var preview;
var ExternalDocsContainer = ({ projectAnnotations, children }) => (preview || (preview = new ExternalPreview(projectAnnotations)), import_react89.default.createElement(DocsContext.Provider, { value: preview.docsContext() }, import_react89.default.createElement(ThemeProvider, { theme: ensure(themes.light) }, children)));
var Meta = ({ of }) => {
  let context = (0, import_react90.useContext)(DocsContext);
...
//# sourceMappingURL=chunk-3SLVBYLH.js.map
