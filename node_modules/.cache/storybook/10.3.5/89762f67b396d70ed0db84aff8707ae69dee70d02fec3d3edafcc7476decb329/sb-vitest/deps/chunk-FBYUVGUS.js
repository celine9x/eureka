...
function C(n = false) {
  let e = typeof process < "u" ? process : void 0, i = (e == null ? void 0 : e.env) || {}, g2 = (e == null ? void 0 : e.argv) || [];
  return !("NO_COLOR" in i || g2.includes("--no-color")) && ("FORCE_COLOR" in i || g2.includes("--color") || (e == null ? void 0 : e.platform) === "win32" || n && i.TERM !== "dumb" || "CI" in i) || typeof window < "u" && !!window.chrome;
}
function p(n = false) {
  let e = C(n), i = (r, t, c, o) => {
    let l = "", s22 = 0;
...
function diffStrings(a22, b, options) {
  let truncate22 = (options == null ? void 0 : options.truncateThreshold) ?? false, truncateThreshold = Math.max(Math.floor((options == null ? void 0 : options.truncateThreshold) ?? 0), 0), aLength = a22.length, bLength = b.length;
  if (truncate22) {
...
var Instrumenter = class {
  constructor() {
    ...
    this.loadParentWindowState = () => {
      var _a3, _b;
      try {
        this.state = ((_b = (_a3 = scope.window) == null ? void 0 : _a3.parent) == null ? void 0 : _b.__STORYBOOK_ADDON_INTERACTIONS_INSTRUMENTER_STATE__) || {};
      } catch {
        this.detached = true;
      }
    };
    ...
    let resetState = ({
      ...
      this.setState(storyId, ({ shadowCalls }) => {
        ...
        return {
          playUntil: (_a3 = shadowCalls.slice(0, firstRowIndex).filter((call2) => {
            var _a4;
            return call2.interceptable && !((_a4 = call2.ancestors) == null ? void 0 : _a4.length);
          }).slice(-1)[0]) == null ? void 0 : _a3.id
        };
      }), channel.emit(FORCE_REMOUNT, { storyId, isDebugging: true });
    }, back = (channel) => ({ storyId }) => {
      var _a3;
      let log = this.getLog(storyId).filter((call2) => {
        var _a4;
        return !((_a4 = call2.ancestors) == null ? void 0 : _a4.length);
      }), last = log.reduceRight((res, item, index2) => res >= 0 || item.status === "waiting" ? res : index2, -1);
      start(channel)({ storyId, playUntil: (_a3 = log[last - 1]) == null ? void 0 : _a3.callId });
      ...
      if (!call2 && shadowCall && Object.values(resolvers).length > 0) {
        let nextId = (_a3 = this.getLog(storyId).find(
          (c) => c.status === "waiting"
          /* WAITING */
        )) == null ? void 0 : _a3.callId;
  ...
  cleanup() {
    ...
    (_a3 = this.channel) == null ? void 0 : _a3.emit(EVENTS.SYNC, payload), this.updateParentWindowState();
  }
  getLog(storyId) {
      ...
      (acc, key) => {
        ...
        if (typeof (descriptor == null ? void 0 : descriptor.get) == "function") {
          if (descriptor.configurable) {
            let getter = () => {
              var _a3, _b;
              return (_b = (_a3 = descriptor == null ? void 0 : descriptor.get) == null ? void 0 : _a3.bind(obj)) == null ? void 0 : _b();
            };
  ...
  track(method, fn3, object, args, options) {
    var _a3, _b, _c, _d;
    let storyId = ((_a3 = args == null ? void 0 : args[0]) == null ? void 0 : _a3.__storyId__) || ((_d = (_c = (_b = scope.__STORYBOOK_PREVIEW__) == null ? void 0 : _b.selectionStore) == null ? void 0 : _c.selection) == null ? void 0 : _d.storyId), { cursor, ancestors } = this.getState(storyId);
  ...
  invoke(fn3, object, call2, options) {
    let { callRefsByResult, renderPhase } = this.getState(call2.storyId), maximumDepth = 25, serializeValues = (value, depth, seen) => {
      ...
      if (value instanceof ((_a3 = scope.window) == null ? void 0 : _a3.HTMLElement)) {
      ...
      } : typeof value == "symbol" ? { __symbol__: { description: value.description } } : typeof value == "object" && ((_b = value == null ? void 0 : value.constructor) == null ? void 0 : _b.name) && ((_c = value == null ? void 0 : value.constructor) == null ? void 0 : _c.name) !== "Object" ? { __class__: { name: value.constructor.name } } : Object.prototype.toString.call(value) === "[object Object]" ? Object.fromEntries(
    ...
    call2.path.forEach((ref) => {
      (ref == null ? void 0 : ref.__callId__) && this.setState(call2.storyId, ({ chainedCallIds }) => ({
    ...
    let handleException = (e) => {
      ...
      if (e instanceof Error) {
        ...
        })), (_a3 = call2.ancestors) == null ? void 0 : _a3.length)
  ...
  update(call2) {
    var _a3;
    (_a3 = this.channel) == null ? void 0 : _a3.emit(EVENTS.CALL, call2), this.setState(call2.storyId, ({ calls }) => {
  ...
  sync(storyId) {
    let synchronize = () => {
      var _a3, _b, _c;
      let { isLocked, isPlaying } = this.getState(storyId), logItems = this.getLog(storyId), pausedAt = (_a3 = logItems.filter(({ ancestors }) => !ancestors.length).find(
        (item) => item.status === "waiting"
        /* WAITING */
      )) == null ? void 0 : _a3.callId, hasActive = logItems.some(
      ...
      if (this.detached || isLocked || hasActive || logItems.length === 0) {
        ...
        (_b = this.channel) == null ? void 0 : _b.emit(EVENTS.SYNC, payload2);
        return;
      }
      ...
      (_c = this.channel) == null ? void 0 : _c.emit(EVENTS.SYNC, payload);
    };
...
` + indentationNext);
    ...
    var getColorsHighlight2 = (options) => DEFAULT_THEME_KEYS2.reduce((colors, key) => {
      ...
      return {
        ...
        printBasicPrototype: (_options$printBasicPr = options == null ? void 0 : options.printBasicPrototype) !== null && _options$printBasicPr !== void 0 ? _options$printBasicPr : true,
  ...
  function position() {
    ...
    return function(node) {
      return node.position = new $0865a9fb4cc365fe$export$2e2bcd8739ae039(start, {
        line: lineno,
        column
      }, (options == null ? void 0 : options.source) || ""), whitespace(), node;
    };
  }
  let errorsList = [];
  function error(msg) {
...
function roleSupportsChecked(role) {
  var _a3;
  return ((_a3 = import_aria_query.roles.get(role)) == null ? void 0 : _a3.props["aria-checked"]) !== void 0;
}
...
var T = (e) => e[u] || K(e);
var moduleMockSpies = globalThis.__STORYBOOK_MODULE_MOCK_SPIES__ ?? (globalThis.__STORYBOOK_MODULE_MOCK_SPIES__ = /* @__PURE__ */ new Set());
...
function getActiveElement(document2) {
  ...
  return (activeElement == null ? void 0 : activeElement.shadowRoot) ? getActiveElement(activeElement.shadowRoot) : isDisabled2(activeElement) ? document2.ownerDocument ? (
    /* istanbul ignore next */
...
function getTargetTypeAndSelection(node) {
  ...
  return {
    type: getContentEditable(node) && (selection == null ? void 0 : selection.anchorNode) && getContentEditable(selection.anchorNode) ? "contenteditable" : "default",
    selection
  };
}
...
function getActiveTarget(document2) {
  ...
  return (active == null ? void 0 : active.tagName) === "BODY" ? null : active;
}
...
var PointerHost = class {
  ...
  async release(instance, keyDef, position) {
    ...
    if (pointer3.position = position, pointer3.pointerType !== "touch" && (this.mouse.position = position), device.countPressed === 0 && pointer3.up(instance, keyDef.button), pointer3.pointerType === "touch" && pointer3.release(instance), pointer3.pointerType === "touch" && !pointer3.isMultitouch) {
      ...
      mousemove == null ? void 0 : mousemove.leave(), mousemove == null ? void 0 : mousemove.enter(), mousemove == null ? void 0 : mousemove.move(), this.mouse.down(instance, keyDef, isPrevented);
    }
    if (!pointer3.isMultitouch) {
      let mousemove = this.mouse.move(instance, position, isPrevented);
      mousemove == null ? void 0 : mousemove.leave(), mousemove == null ? void 0 : mousemove.enter(), mousemove == null ? void 0 : mousemove.move(), this.mouse.up(instance, keyDef, isPrevented);
    }
  }
...
async function pointerAction(instance, action) {
  ...
  let position = {
    ...
    coords: (_action_coords = action.coords) !== null && _action_coords !== void 0 ? _action_coords : previousPosition == null ? void 0 : previousPosition.coords,
    caret: {
...
testingLibrary.screen = new Proxy(testingLibrary.screen, {
  get(target, prop, receiver) {
    var _a3, _b;
    return typeof window < "u" && ((_b = (_a3 = globalThis.location) == null ? void 0 : _a3.href) == null ? void 0 : _b.includes("viewMode=docs")) && once.warn(dedent`
...
//# sourceMappingURL=chunk-FBYUVGUS.js.map
