...
var convert = (type) => {
  ...
  switch (typeof raw < "u" && (base.raw = raw), type.name) {
    ...
    case "union":
      return ((_a = type.elements) == null ? void 0 : _a.every(isLiteral)) ? { ...base, name: "enum", value: (_b = type.elements) == null ? void 0 : _b.map(toEnumOption) } : { ...base, name, value: (_c = type.elements) == null ? void 0 : _c.map(convert) };
    case "intersection":
      return { ...base, name, value: (_d = type.elements) == null ? void 0 : _d.map(convert) };
    default:
...
var isLiteral2 = (type) => type.name === "literal";
var isUndefined = (type) => type.name === "undefined";
...
function applyJsDocResult(propDef, jsDocParsingResult) {
  ...
  if (jsDocParsingResult == null ? void 0 : jsDocParsingResult.includesJsDoc) {
    ...
    let value = {
      ...extractedTags,
      params: (_a = extractedTags == null ? void 0 : extractedTags.params) == null ? void 0 : _a.map(
        (x) => ({
...
var extractComponentSectionArray = (docgenSection) => {
  ...
  return docgenSection.map((item) => {
    ...
    return ((_a = item.type) == null ? void 0 : _a.elements) && (sanitizedItem = {
      ...item,
      type: {
        ...item.type,
...
//# sourceMappingURL=chunk-OWWWSCPP.js.map
