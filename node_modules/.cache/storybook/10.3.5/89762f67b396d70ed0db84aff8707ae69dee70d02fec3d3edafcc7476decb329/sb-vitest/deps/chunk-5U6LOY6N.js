...
// node_modules/storybook/dist/_browser-chunks/chunk-RD3KTAHR.js
...
var Container = styled.div(({ theme, $flexLayout = false }) => [
  {
...
var ActionBar = ({ actionItems, flexLayout = false, ...props }) => import_react.default.createElement(Container, { ...props, $flexLayout: flexLayout }, actionItems.map(({ title, className, onClick, disabled }, index) => import_react.default.createElement(ActionButton, { key: index, className, onClick, disabled: !!disabled }, title)));
...
function createContextScope(scopeName, createContextScopeDeps = []) {
  ...
  function createContext3(rootComponentName, defaultContext) {
    ...
    function Provider(props) {
      let { scope: scope2, children, ...context } = props, Context = (scope2 == null ? void 0 : scope2[scopeName][index]) || BaseContext, value = React7.useMemo(() => context, Object.values(context));
      return (0, import_jsx_runtime3.jsx)(Context.Provider, { value, children });
    }
    function useContext22(consumerName, scope2) {
      let Context = (scope2 == null ? void 0 : scope2[scopeName][index]) || BaseContext, context = React7.useContext(Context);
  ...
  let createScope = () => {
    ...
    return function(scope2) {
      let contexts = (scope2 == null ? void 0 : scope2[scopeName]) || scopeContexts;
...
var ScrollArea2 = (0, import_react2.forwardRef)(
  ({
    ...
    className,
    focusable = false
  }, ref) => import_react2.default.createElement(ScrollAreaRoot, { scrollbarsize: scrollbarSize, offset, className }, import_react2.default.createElement(
    ScrollAreaViewport2,
    {
      ref,
      style: { scrollPadding },
    ...
    children
  ), horizontal && import_react2.default.createElement(
...
//# sourceMappingURL=chunk-5U6LOY6N.js.map
