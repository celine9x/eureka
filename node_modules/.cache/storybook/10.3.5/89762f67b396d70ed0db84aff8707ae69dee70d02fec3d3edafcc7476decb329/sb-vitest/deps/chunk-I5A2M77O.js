...
} from "./chunk-BZH7WH6B.js";
import {
  SNIPPET_RENDERED,
  SourceType
} from "./chunk-OWWWSCPP.js";
import {
  useMDXComponents
} from "./chunk-ERQNILTA.js";
import {
  Channel
} from "./chunk-EDBTOAYE.js";
import {
  GLOBALS_UPDATED,
  NAVIGATE_URL,
  RESET_STORY_ARGS,
...
import {
  require_react_dom
} from "./chunk-YVM75EZO.js";
import {
  require_react
} from "./chunk-TANRUWGG.js";
import {
  __toESM
...
var DateControl = ({ name, value, onChange, onFocus, onBlur, argType }) => {
  var _a;
  ...
  (0, import_react8.useEffect)(() => {
    valid !== false && (dateRef && dateRef.current && (dateRef.current.value = value ? formatDate(value) : ""), timeRef && timeRef.current && (timeRef.current.value = value ? formatTime(value) : ""));
  }, [value]);
  let onDateChange = (e2) => {
    if (!e2.target.value)
      return onChange();
...
var format2 = (value) => value != null ? String(value) : "";
...
var NumberControl = ({
  ...
  var _a;
  let [inputValue, setInputValue] = (0, import_react9.useState)(typeof value == "number" ? value : ""), [forceVisible, setForceVisible] = (0, import_react9.useState)(false), [parseError, setParseError] = (0, import_react9.useState)(null), readonly = !!((_a = argType == null ? void 0 : argType.table) == null ? void 0 : _a.readonly), handleChange = (0, import_react9.useCallback)(
    (event) => {
  ...
  }, [value]), value === void 0 ? import_react9.default.createElement(
    Button,
    {
      ariaLabel: false,
      variant: "outline",
...
var selectedKeys = (value, options) => value && options ? Object.entries(options).filter((entry) => value.includes(entry[1])).map((entry) => entry[0]) : [];
...
var CheckboxControl = ({
  ...
  let initial2 = selectedKeys(value || [], options), [selected, setSelected] = (0, import_react11.useState)(initial2), readonly = !!((_a = argType == null ? void 0 : argType.table) == null ? void 0 : _a.readonly), handleChange = (e2) => {
...
var RadioControl = ({
  ...
  let selection = selectedKey(value, options), controlId = getControlId(name), readonly = !!((_a = argType == null ? void 0 : argType.table) == null ? void 0 : _a.readonly);
...
var SingleSelect = ({ name, value, options, onChange, argType }) => {
  var _a;
  let handleChange = (e2) => {
    onChange(options[e2.currentTarget.value]);
  }, selection = selectedKey(value, options) || NO_SELECTION, controlId = getControlId(name), readonly = !!((_a = argType == null ? void 0 : argType.table) == null ? void 0 : _a.readonly);
...
var MultiSelect = ({ name, value, options, onChange, argType }) => {
  var _a;
  let handleChange = (e2) => {
  ...
  }, selection = selectedKeys(value, options), controlId = getControlId(name), readonly = !!((_a = argType == null ? void 0 : argType.table) == null ? void 0 : _a.readonly);
...
var JsonArray = class extends import_react16.Component {
  ...
  renderCollapsed() {
    let { name, data, keyPath, deep } = this.state, { handleRemove, readOnly, dataType, minusMenuElement } = this.props, isReadOnly = readOnly(name, data, keyPath, deep, dataType), removeItemButton = minusMenuElement && (0, import_react16.cloneElement)(minusMenuElement, {
      onClick: handleRemove,
      className: "rejt-minus-menu",
      "aria-label": `remove the array '${String(name)}'`
    });
    return import_react16.default.createElement(import_react16.default.Fragment, null, import_react16.default.createElement("span", { className: "rejt-collapsed-value" }, "[...] ", data.length, " ", data.length === 1 ? "item" : "items"), !isReadOnly && removeItemButton);
  }
  renderNotCollapsed() {
    let { name, data, keyPath, deep, addFormVisible, nextDeep } = this.state, {
      ...
      logger: logger5,
      onSubmitValueParser
    } = this.props, isReadOnly = readOnly(name, data, keyPath, deep, dataType), addItemButton = plusMenuElement && (0, import_react16.cloneElement)(plusMenuElement, {
    ...
    return import_react16.default.createElement(import_react16.default.Fragment, null, import_react16.default.createElement("span", { className: "rejt-not-collapsed-delimiter" }, "["), !addFormVisible && addItemButton, import_react16.default.createElement("ul", { className: "rejt-not-collapsed-list" }, data.map((item, index) => import_react16.default.createElement(
      JsonNode,
      {
        key: index,
        name: index.toString(),
    ...
    ))), !isReadOnly && addFormVisible && import_react16.default.createElement("div", { className: "rejt-add-form" }, import_react16.default.createElement(
      JsonAddValue,
      {
    ...
    )), import_react16.default.createElement("span", { className: "rejt-not-collapsed-delimiter" }, "]"), !isReadOnly && removeItemButton);
  }
  render() {
...
var JsonFunctionValue = class extends import_react16.Component {
  ...
  render() {
    ...
    if (editEnabled && !resultOnlyResult) {
      ...
      result = import_react16.default.createElement("span", { className: "rejt-edit-form" }, textareaElementLayout), minusElement = null;
    } else {
      result = import_react16.default.createElement("span", { className: "rejt-value", onClick: resultOnlyResult ? void 0 : this.handleEditMode }, value);
    ...
    return import_react16.default.createElement("li", { className: "rejt-value-node" }, import_react16.default.createElement("span", { className: "rejt-name" }, name, " : "), result, minusElement);
  }
};
...
var JsonObject = class extends import_react16.Component {
  ...
  renderCollapsed() {
    let { name, keyPath, deep, data } = this.state, { handleRemove, readOnly, dataType, minusMenuElement } = this.props, keyList = Object.getOwnPropertyNames(data), isReadOnly = readOnly(name, data, keyPath, deep, dataType), removeItemButton = minusMenuElement && (0, import_react16.cloneElement)(minusMenuElement, {
      onClick: handleRemove,
      className: "rejt-minus-menu",
      "aria-label": `remove the object '${String(name)}'`
    });
    return import_react16.default.createElement(import_react16.default.Fragment, null, import_react16.default.createElement("span", { className: "rejt-collapsed-value" }, "{...}", " ", keyList.length, " ", keyList.length === 1 ? "key" : "keys"), !isReadOnly && removeItemButton);
  }
  renderNotCollapsed() {
    let { name, data, keyPath, deep, nextDeep, addFormVisible } = this.state, {
      ...
      logger: logger5,
      onSubmitValueParser
    } = this.props, keyList = Object.getOwnPropertyNames(data), isReadOnly = readOnly(name, data, keyPath, deep, dataType), addItemButton = plusMenuElement && (0, import_react16.cloneElement)(plusMenuElement, {
      onClick: this.handleAddMode,
      className: "rejt-plus-menu",
    ...
    return import_react16.default.createElement(import_react16.default.Fragment, null, import_react16.default.createElement("span", { className: "rejt-not-collapsed-delimiter" }, "{"), !isReadOnly && addItemButton, import_react16.default.createElement("ul", { className: "rejt-not-collapsed-list" }, list), !isReadOnly && addFormVisible && import_react16.default.createElement("div", { className: "rejt-add-form" }, import_react16.default.createElement(
      JsonAddValue,
      {
        handleAdd: this.handleAddValueAdd,
        handleCancel: this.handleAddValueCancel,
...
var JsonValue = class extends import_react16.Component {
  ...
  render() {
    ...
    return import_react16.default.createElement("li", { className: "rejt-value-node" }, import_react16.default.createElement("span", { className: "rejt-name" }, name, " : "), isEditing ? import_react16.default.createElement("span", { className: "rejt-edit-form" }, inputElementLayout) : import_react16.default.createElement("span", { className: "rejt-value", onClick: isReadOnly ? void 0 : this.handleEditMode }, String(value)), !isReadOnly && !isEditing && minusMenuLayout);
  }
};
...
var ObjectControl = ({ name, value, onChange, argType }) => {
  var _a;
  let theme = useTheme(), data = (0, import_react14.useMemo)(() => value && cloneDeep(value), [value]), hasData = data != null, [showRaw, setShowRaw] = (0, import_react14.useState)(!hasData), [parseError, setParseError] = (0, import_react14.useState)(null), readonly = !!((_a = argType == null ? void 0 : argType.table) == null ? void 0 : _a.readonly), updateRaw = (0, import_react14.useCallback)(
    (raw) => {
      try {
  ...
  }, [onChange, setForceVisible]), htmlElRef = (0, import_react14.useRef)(null);
  ...
  ), isObjectOrArray = Array.isArray(value) || typeof value == "object" && (value == null ? void 0 : value.constructor) === Object;
  return import_react14.default.createElement(Wrapper4, null, isObjectOrArray && import_react14.default.createElement(
    ...
    import_react14.default.createElement(EditIcon, null)
...
var RangeControl = ({
  ...
  }, hasValue = value !== void 0, numberOFDecimalsPlaces = (0, import_react18.useMemo)(() => getNumberOfDecimalPlaces(step), [step]), readonly = !!((_a = argType == null ? void 0 : argType.table) == null ? void 0 : _a.readonly), controlId = getControlId(name);
  ...
  ), import_react18.default.createElement(RangeCurrentAndMaxLabel, { numberOFDecimalsPlaces, max }, hasValue ? value.toFixed(numberOFDecimalsPlaces) : "--", " / ", max));
};
...
var TextControl = ({
  ...
  ), maxLength && import_react19.default.createElement(MaxLength, { isMaxed: (value == null ? void 0 : value.length) === maxLength }, (value == null ? void 0 : value.length) ?? 0, " / ", maxLength));
};
...
var LazyColorControl = (0, import_react6.lazy)(() => import("./Color-FRDS63T2-4ANS53AZ.js"));
...
var ArgSummary = ({ value, initialExpandedArgs }) => {
  let { summary, detail } = value, [isOpen, setIsOpen] = (0, import_react22.useState)(false), [isExpanded, setIsExpanded] = (0, import_react22.useState)(initialExpandedArgs || false);
  if (summary == null)
    return null;
...
var ArgValue = ({ value, initialExpandedArgs }) => value == null ? import_react22.default.createElement(EmptyArg, null) : import_react22.default.createElement(ArgSummary, { value, initialExpandedArgs });
...
var toSummary = (value) => value && { summary: typeof value == "string" ? value : value.name };
var ArgRow = (props) => {
  var _a;
...
var $f0a04ccd8dbdd83b$export$e5c5a5f917a5871c = typeof document < "u" ? import_react28.default.useLayoutEffect : () => {
};
var $b5e257d569688ac6$var$defaultContext = {
  prefix: String(Math.round(Math.random() * 1e10)),
  current: 0
};
var $b5e257d569688ac6$var$SSRContext = import_react31.default.createContext($b5e257d569688ac6$var$defaultContext);
var $b5e257d569688ac6$var$IsSSRContext = import_react31.default.createContext(false);
var $b5e257d569688ac6$var$canUseDOM = !!(typeof window < "u" && window.document && window.document.createElement);
var $b5e257d569688ac6$var$componentIds = /* @__PURE__ */ new WeakMap();
function $b5e257d569688ac6$var$useCounter(isDisabled = false) {
  let ctx = (0, import_react31.useContext)($b5e257d569688ac6$var$SSRContext), ref = (0, import_react31.useRef)(null);
  if (ref.current === null && !isDisabled) {
    var _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner, _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
    let currentOwner = (_React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = import_react31.default.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED) === null || _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED === void 0 || (_React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner = _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner) === null || _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner === void 0 ? void 0 : _React___SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED_ReactCurrentOwner.current;
    if (currentOwner) {
...
function $b5e257d569688ac6$var$useLegacySSRSafeId(defaultId) {
  let ctx = (0, import_react31.useContext)($b5e257d569688ac6$var$SSRContext);
  ctx === $b5e257d569688ac6$var$defaultContext && !$b5e257d569688ac6$var$canUseDOM && true && console.warn("When server rendering, you must wrap your application in an <SSRProvider> to ensure consistent ids are generated between the client and server.");
  let counter = $b5e257d569688ac6$var$useCounter(!!defaultId), prefix = ctx === $b5e257d569688ac6$var$defaultContext && false ? "react-aria" : `react-aria${ctx.prefix}`;
  return defaultId || `${prefix}-${counter}`;
}
function $b5e257d569688ac6$var$useModernSSRSafeId(defaultId) {
  let id = import_react31.default.useId(), [didSSR] = (0, import_react31.useState)($b5e257d569688ac6$export$535bd6ca7f90a273()), prefix = didSSR || false ? "react-aria" : `react-aria${$b5e257d569688ac6$var$defaultContext.prefix}`;
  return defaultId || `${prefix}-${id}`;
}
var $b5e257d569688ac6$export$619500959fc48b26 = typeof import_react31.default.useId == "function" ? $b5e257d569688ac6$var$useModernSSRSafeId : $b5e257d569688ac6$var$useLegacySSRSafeId;
...
function $b5e257d569688ac6$export$535bd6ca7f90a273() {
  return typeof import_react31.default.useSyncExternalStore == "function" ? import_react31.default.useSyncExternalStore($b5e257d569688ac6$var$subscribe, $b5e257d569688ac6$var$getSnapshot, $b5e257d569688ac6$var$getServerSnapshot) : (0, import_react31.useContext)($b5e257d569688ac6$var$IsSSRContext);
}
var $bdb11010cef70236$var$canUseDOM = !!(typeof window < "u" && window.document && window.document.createElement);
...
function $bdb11010cef70236$export$f680877a34711e37(defaultId) {
  let [value, setValue] = (0, import_react30.useState)(defaultId), nextId = (0, import_react30.useRef)(null), res = $b5e257d569688ac6$export$619500959fc48b26(value), cleanupRef = (0, import_react30.useRef)(null);
  ...
  if ($7215afc6de606d6b$var$supportsPreventScrollCached == null) {
    ...
    try {
      document.createElement("div").focus({
        get preventScroll() {
          return $7215afc6de606d6b$var$supportsPreventScrollCached = true, true;
        }
      });
    } catch {
    }
...
function $c87311424ea30a05$var$testPlatform(re2) {
  var _window_navigator_userAgentData;
  return typeof window < "u" && window.navigator != null ? re2.test(((_window_navigator_userAgentData = window.navigator.userAgentData) === null || _window_navigator_userAgentData === void 0 ? void 0 : _window_navigator_userAgentData.platform) || window.navigator.platform) : false;
}
...
var $ea8dcbcb9ea1b556$var$RouterContext = (0, import_react32.createContext)({
  isNative: true,
...
function $ea8dcbcb9ea1b556$export$95185d699e05d4d7(target, modifiers, setOpening = true) {
  ...
  $c87311424ea30a05$export$b7d78993b74f766d() && (!((_window_event = window.event) === null || _window_event === void 0 || (_window_event_type = _window_event.type) === null || _window_event_type === void 0) && _window_event_type.startsWith("key")) && target.target === "_blank" && ($c87311424ea30a05$export$9ac100e40613ea10() ? metaKey = true : ctrlKey = true);
  ...
  $ea8dcbcb9ea1b556$export$95185d699e05d4d7.isOpening = setOpening, $7215afc6de606d6b$export$de79e2c695e052f3(target), target.dispatchEvent(event), $ea8dcbcb9ea1b556$export$95185d699e05d4d7.isOpening = false;
}
...
var $8ae05eaa5c114e9c$var$useEarlyEffect = ($8ae05eaa5c114e9c$var$_React_useInsertionEffect = import_react36.default.useInsertionEffect) !== null && $8ae05eaa5c114e9c$var$_React_useInsertionEffect !== void 0 ? $8ae05eaa5c114e9c$var$_React_useInsertionEffect : $f0a04ccd8dbdd83b$export$e5c5a5f917a5871c;
...
var $458b0a5536c1a7cf$var$useEarlyEffect = typeof document < "u" ? ($458b0a5536c1a7cf$var$_React_useInsertionEffect = import_react49.default.useInsertionEffect) !== null && $458b0a5536c1a7cf$var$_React_useInsertionEffect !== void 0 ? $458b0a5536c1a7cf$var$_React_useInsertionEffect : import_react49.default.useLayoutEffect : () => {
};
globalThis && globalThis.__DOCS_CONTEXT__ === void 0 && (globalThis.__DOCS_CONTEXT__ = (0, import_react50.createContext)(null), globalThis.__DOCS_CONTEXT__.displayName = "DocsContext");
var DocsContext2 = globalThis ? globalThis.__DOCS_CONTEXT__ : (0, import_react50.createContext)(null);
function useStory(storyId, context) {
  let stories = useStories([storyId], context);
  return stories && stories[0];
}
function useStories(storyIds, context) {
  let [storiesById, setStories] = (0, import_react52.useState)({});
...
var MDX_WRAPPED_BLOCK = Symbol("mdxWrappedBlock");
var MdxWrappedBlockContext = import_react53.default.createContext(null);
var withMdxComponentOverride = (blockName, Block) => {
  let WrappedBlock = (props) => {
    let wrappedBlocks = import_react53.default.useContext(MdxWrappedBlockContext), Override = useMDXComponents()[blockName];
    if ((wrappedBlocks == null ? void 0 : wrappedBlocks.has(blockName)) || Override === WrappedBlock)
      return import_react53.default.createElement(Block, { ...props });
    if (Override) {
      let nextWrappedBlocks = new Set(wrappedBlocks ?? []);
      return nextWrappedBlocks.add(blockName), import_react53.default.createElement(MdxWrappedBlockContext.Provider, { value: nextWrappedBlocks }, import_react53.default.createElement(Override, { ...props }));
    }
    return import_react53.default.createElement(Block, { ...props });
  };
  return WrappedBlock.displayName = blockName, WrappedBlock[MDX_WRAPPED_BLOCK] = true, WrappedBlock;
};
...
var StoryImpl = (props = { __forceInitialArgs: false, __primary: false }) => {
  let context = (0, import_react51.useContext)(DocsContext2), storyId = getStoryId(props, context), story = useStory(storyId, context);
  if (!story)
    return import_react51.default.createElement(StorySkeleton, null);
  let storyProps = getStoryProps(props, story, context);
  return storyProps ? import_react51.default.createElement(Story, { ...storyProps }) : null;
};
var Story2 = withMdxComponentOverride("Story", StoryImpl);
...
var IFrame = class extends import_react56.Component {
  constructor() {
    super(...arguments);
    this.iframe = null;
  }
...
var ZoomContext = (0, import_react57.createContext)({
  scale: 1
});
var storyBlockIdFromId = ({ story, primary }) => `story--${story.id}${primary ? "--primary" : ""}`;
var InlineStory = (props) => {
  let storyRef = (0, import_react55.useRef)(), [showLoader, setShowLoader] = (0, import_react55.useState)(true), [error, setError] = (0, import_react55.useState)(), { story, height, autoplay, forceInitialArgs, renderStoryToElement } = props;
  ...
  }, [autoplay, renderStoryToElement, story]), error ? import_react55.default.createElement("pre", null, import_react55.default.createElement(ErrorFormatter, { error })) : import_react55.default.createElement(import_react55.default.Fragment, null, height ? import_react55.default.createElement("style", null, `#${storyBlockIdFromId(
    props
  )} { min-height: ${height}; transform: translateZ(0); overflow: auto }`) : null, showLoader && import_react55.default.createElement(StorySkeleton, null), import_react55.default.createElement("div", { ref: storyRef, id: `${storyBlockIdFromId(props)}-inner`, "data-name": story.name }));
};
var IFrameStory = ({ story, height = "500px" }) => import_react55.default.createElement("div", { style: { width: "100%", height } }, import_react55.default.createElement(ZoomContext.Consumer, null, ({ scale }) => import_react55.default.createElement(
  IFrame,
  {
    key: "iframe",
    id: `iframe--${story.id}`,
...
var Story = (props) => {
  ...
  return inline && !props.autoplay && story.usesMount ? import_react55.default.createElement(ErrorMessage, null, "This story mounts inside of play. Set", " ", import_react55.default.createElement("a", { href: "https://storybook.js.org/docs/api/doc-blocks/doc-block-story?ref=ui#autoplay" }, "autoplay"), " ", "to true to view this story.") : import_react55.default.createElement("div", { id: storyBlockIdFromId(props), className: "sb-story sb-unstyled", "data-story-block": "true" }, inline ? import_react55.default.createElement(InlineStory, { ...props }) : import_react55.default.createElement(IFrameStory, { ...props }));
};
var StorySkeleton = () => import_react55.default.createElement(Loader, null);
...
var Toolbar2 = ({ isLoading, storyId, zoom, resetZoom, ...rest }) => import_react58.default.createElement(AbsoluteBar, { innerStyle: { gap: 4, paddingInline: 7, justifyContent: "space-between" }, ...rest }, import_react58.default.createElement(Wrapper7, { key: "left" }, isLoading ? [1, 2, 3].map((key) => import_react58.default.createElement(IconPlaceholder, { key })) : import_react58.default.createElement(import_react58.default.Fragment, null, import_react58.default.createElement(
  Button,
  {
    padding: "small",
    variant: "ghost",
  ...
  import_react58.default.createElement(ZoomIcon, null)
  ...
  import_react58.default.createElement(ZoomOutIcon, null)
), import_react58.default.createElement(
  Button,
  {
    padding: "small",
  ...
  import_react58.default.createElement(ZoomResetIcon, null)
))), isLoading ? import_react58.default.createElement(Wrapper7, { key: "right" }, import_react58.default.createElement(IconPlaceholder, null)) : storyId && import_react58.default.createElement(Wrapper7, { key: "right" }, import_react58.default.createElement(
  Button,
  {
    asChild: true,
    padding: "small",
  ...
  import_react58.default.createElement("a", { href: getStoryHref(storyId), target: "_blank", rel: "noopener noreferrer" }, import_react58.default.createElement(ShareAltIcon, null))
)));
...
var COPIED_LABEL_ANIMATION_DURATION = 2e3;
var Preview2 = ({
  isLoading,
  isColumn,
  columns,
  ...
  let [expanded, setExpanded] = (0, import_react27.useState)(isExpanded), [copied, setCopied] = (0, import_react27.useState)(null), [scale, setScale] = (0, import_react27.useState)(1), additionalActionItems = (0, import_react27.useMemo)(
    () => additionalActions ? [...additionalActions] : [],
    [additionalActions]
  ), sourceId = $bdb11010cef70236$export$f680877a34711e37(), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), context = (0, import_react27.useContext)(DocsContext2), copyToClipboard = (0, import_react27.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./components-ZSN7CBLG.js");
    await createCopyToClipboardFunction()(text);
  }, []), handleCopyCode = (0, import_react27.useCallback)(async () => {
    try {
      await copyToClipboard((withSource == null ? void 0 : withSource.code) ?? ""), setCopied("Copied!");
    } catch (err) {
      logger.error(err), setCopied("Copy error!");
    }
    globalThis.window.setTimeout(() => setCopied(null), COPIED_LABEL_ANIMATION_DURATION);
  }, [copyToClipboard, withSource == null ? void 0 : withSource.code]), childProps = getChildProps(children), hasSourceError = !!(withSource && withSource.error), hasValidSource = !!(withSource && !withSource.error);
  return import_react27.default.createElement(import_react27.default.Fragment, null, import_react27.default.createElement(
    PreviewContainer,
    {
      withSource,
      withToolbar,
    ...
    import_react27.default.createElement(ZoomContext.Provider, { value: { scale } }, import_react27.default.createElement(
      ChildrenContainer,
      {
    ...
    hasValidSource && expanded && import_react27.default.createElement("div", { id: sourceId }, import_react27.default.createElement(StyledSource, { ...withSource, dark: true, copyable: false }))
  ), (withSource || additionalActionItems.length > 0) && import_react27.default.createElement(ActionBar, { className: "sbdocs sbdocs-preview-actions", innerStyle: { paddingInline: 0 } }, hasSourceError && import_react27.default.createElement(
    Button,
    {
      ariaLabel: false,
      disabled: true,
    ...
    import_react27.default.createElement(MarkupIcon, null),
    " No code available"
  ), hasValidSource && import_react27.default.createElement(import_react27.default.Fragment, null, import_react27.default.createElement(
    ToggleButton,
    {
      ariaLabel: false,
      pressed: expanded,
  ...
  ), import_react27.default.createElement(Button, { ariaLabel: false, variant: "ghost", onClick: handleCopyCode }, import_react27.default.createElement(CopyIcon, null), " ", copied ?? "Copy code")), additionalActionItems.map(({ title, className: className2, onClick, disabled }, index) => import_react27.default.createElement(
    Button,
    {
      key: index,
...
var TabbedArgsTable = ({ tabs, ...props }) => {
  ...
  if (entries.length === 1)
    return import_react59.default.createElement(ArgsTable, { ...entries[0][1], ...props });
  let tabsFromEntries = entries.map(([label, table], index) => ({
    ...
    children: () => {
      ...
      return import_react59.default.createElement(ArgsTable, { inTabPanel: true, key: `prop_table_${label}`, ...table, ...argsTableProps });
    }
  }));
  return import_react59.default.createElement(StyledTabsView, { tabs: tabsFromEntries });
};
...
var Typeset = ({
  ...
  sampleText,
  ...props
}) => import_react60.default.createElement(Wrapper8, { ...props, className: "docblock-typeset sb-unstyled" }, fontSizes.map((size) => import_react60.default.createElement(TypeSpecimen, { key: size }, import_react60.default.createElement(Label4, null, size), import_react60.default.createElement(
  Sample,
  {
    style: {
      fontFamily,
...
function renderSwatch(color, index) {
  return import_react61.default.createElement(Swatch, { key: `${color}-${index}`, title: color, background: color });
}
function renderSwatchLabel(color, index, colorDescription) {
  return import_react61.default.createElement(SwatchLabel, { key: `${color}-${index}`, title: color }, import_react61.default.createElement("div", null, color, colorDescription && import_react61.default.createElement("span", null, colorDescription)));
}
function renderSwatchSpecimen(colors) {
  if (Array.isArray(colors))
    return import_react61.default.createElement(SwatchSpecimen, null, import_react61.default.createElement(SwatchColors, null, colors.map((color, index) => renderSwatch(color, index))), import_react61.default.createElement(SwatchLabels, null, colors.map((color, index) => renderSwatchLabel(color, index))));
  ...
  return import_react61.default.createElement(SwatchSpecimen, null, import_react61.default.createElement(SwatchColors, null, swatchElements), import_react61.default.createElement(SwatchLabels, null, labelElements));
}
var ColorItem = ({ title, subtitle, colors }) => import_react61.default.createElement(Item, null, import_react61.default.createElement(ItemDescription, null, import_react61.default.createElement(ItemTitle, null, title), import_react61.default.createElement(ItemSubtitle, null, subtitle)), import_react61.default.createElement(Swatches, null, renderSwatchSpecimen(colors)));
var ColorPalette = ({ children, ...props }) => import_react61.default.createElement(ResetWrapper, null, import_react61.default.createElement(List, { ...props, className: "docblock-colorpalette sb-unstyled" }, import_react61.default.createElement(ListHeading, null, import_react61.default.createElement(ListName, null, "Name"), import_react61.default.createElement(ListSwatches, null, "Swatches")), children));
...
var IconItem = ({ name, children }) => import_react62.default.createElement(Item2, null, import_react62.default.createElement(ItemSpecimen, null, children), import_react62.default.createElement(ItemLabel, null, name));
var IconGallery = ({ children, ...props }) => import_react62.default.createElement(ResetWrapper, null, import_react62.default.createElement(List2, { ...props, className: "docblock-icongallery sb-unstyled" }, children));
...
function parseContent(options) {
  ...
  function addNode(node, nest) {
    ...
    return level >= options.collapseDepth && (obj.isCollapsed = true), array.push(obj), array;
  }
...
var Title2 = ({ headingId, title }) => typeof title == "string" || !title ? import_react63.default.createElement(Heading, { as: "h2", id: headingId, className: title ? "" : "sb-sr-only" }, title || "Table of contents") : import_react63.default.createElement("div", { id: headingId }, title);
var TableOfContents = ({
  title,
  disable,
  headingSelector,
  ...
  return import_react63.default.createElement(Aside, { className }, disable ? null : import_react63.default.createElement(Nav, { "aria-labelledby": headingId }, import_react63.default.createElement(Title2, { headingId, title }), import_react63.default.createElement("div", { className: "toc-wrapper" })));
};
var anchorBlockIdFromId = (storyId) => `anchor--${storyId}`;
var Anchor = ({ storyId, children }) => import_react64.default.createElement("div", { id: anchorBlockIdFromId(storyId), className: "sb-anchor" }, children);
var useOf = (moduleExportOrType, validTypes) => (0, import_react66.useContext)(DocsContext2).resolveOf(moduleExportOrType, validTypes);
...
var ArgTypesImpl = (props) => {
  ...
  if ("of" in props && of === void 0)
    throw new Error("Unexpected `of={undefined}`, did you mistype a CSF file reference?");
  let resolved = useOf(of || "meta"), { argTypes, parameters, component, subcomponents } = getArgTypesFromResolved(resolved), argTypesParameters = ((_a = parameters == null ? void 0 : parameters.docs) == null ? void 0 : _a.argTypes) || {}, include = props.include ?? argTypesParameters.include, exclude = props.exclude ?? argTypesParameters.exclude, sort = props.sort ?? argTypesParameters.sort, filteredArgTypes = filterArgTypes(argTypes, include, exclude);
  if (!(!!subcomponents && Object.keys(subcomponents || {}).length > 0))
    return import_react65.default.createElement(ArgsTable, { rows: filteredArgTypes, sort });
  ...
  return import_react65.default.createElement(TabbedArgsTable, { tabs, sort });
};
var ArgTypes = withMdxComponentOverride("ArgTypes", ArgTypesImpl);
...
var replacer = function(options) {
  ...
  return function(key, value) {
    ...
    try {
      ...
      if (((_a = value == null ? void 0 : value.constructor) == null ? void 0 : _a.name) && value.constructor.name !== "Object" && !Array.isArray(value)) {
...
var SourceContext = (0, import_react69.createContext)({ sources: {} });
var UNKNOWN_ARGS_HASH = "--unknown--";
var SourceContainer = ({
  children,
  channel
}) => {
  let [sources, setSources] = (0, import_react69.useState)({});
  ...
  }, []), import_react69.default.createElement(SourceContext.Provider, { value: { sources } }, children);
};
function useTransformCode(source, transform, storyContext) {
  let [transformedCode, setTransformedCode] = (0, import_react70.useState)("Transforming..."), transformed = transform ? transform == null ? void 0 : transform(source, storyContext) : source;
...
var useSourceProps = (props, docsContext, sourceContext) => {
  var _a, _b;
  let { of } = props, story = (0, import_react68.useMemo)(() => {
    if (of)
...
var SourceImpl = (props) => {
  let sourceContext = (0, import_react68.useContext)(SourceContext), docsContext = (0, import_react68.useContext)(DocsContext2), sourceProps = useSourceProps(props, docsContext, sourceContext);
  return import_react68.default.createElement(Source, { ...sourceProps });
};
var Source2 = withMdxComponentOverride("Source", SourceImpl);
var CanvasImpl = (props) => {
  var _a, _b, _c, _d, _e2, _f, _g, _h, _i, _j, _k, _l, _m, _n;
  let docsContext = (0, import_react67.useContext)(DocsContext2), sourceContext = (0, import_react67.useContext)(SourceContext), { of, source } = props;
  if ("of" in props && of === void 0)
    throw new Error("Unexpected `of={undefined}`, did you mistype a CSF file reference?");
  ...
  return import_react67.default.createElement(
    ...
    import_react67.default.createElement(Story2, { of: of || story.moduleExport, meta: props.meta, ...props.story })
  );
};
var Canvas = withMdxComponentOverride("Canvas", CanvasImpl);
...
var useArgsIfDefined = (story, context) => {
  let storyContext = story ? context.getStoryContext(story) : { args: {} }, { id: storyId } = story || { id: "none" }, [args, setArgs] = (0, import_react72.useState)(storyContext.args);
  ...
  let updateArgs = (0, import_react72.useCallback)(
    (updatedArgs) => context.channel.emit(UPDATE_STORY_ARGS, { storyId, updatedArgs }),
    [storyId, context.channel]
  ), resetArgs = (0, import_react72.useCallback)(
...
var useGlobals = (story, context) => {
  let storyContext = context.getStoryContext(story), [globals, setGlobals] = (0, import_react73.useState)(storyContext.globals);
...
var usePrimaryStory = () => (0, import_react74.useContext)(DocsContext2).componentStories().find((story) => story.tags.includes(Tag.AUTODOCS));
...
var ControlsImpl = (props) => {
  var _a;
  let { of } = props, context = (0, import_react71.useContext)(DocsContext2), primaryStory = usePrimaryStory(), story = of ? context.resolveOf(of, ["story"]).story : primaryStory;
  if (!story)
    return null;
  ...
  if (!(!!subcomponents && Object.keys(subcomponents || {}).length > 0))
    return Object.keys(filteredArgTypes).length > 0 || Object.keys(args).length > 0 ? import_react71.default.createElement(
      ArgsTable,
      {
...
var Controls3 = withMdxComponentOverride("Controls", ControlsImpl);
...
var AddContext = (props) => {
  let { children, ...rest } = props, parentContext = import_react77.default.useContext(DocsContext2);
  return import_react77.default.createElement(DocsContext2.Provider, { value: { ...parentContext, ...rest } }, children);
};
var CodeOrSourceMdx = ({
  className,
  children,
  ...
  if (typeof className != "string" && (typeof children != "string" || !children.match(/[\n\r]/g)))
    return import_react77.default.createElement(Code, null, children);
...
var AnchorInPage = ({ hash, children }) => {
  let context = (0, import_react77.useContext)(DocsContext2);
  return import_react77.default.createElement(
    A2,
    {
      href: hash,
...
var AnchorMdx = (props) => {
  let { href, target, children, ...rest } = props, context = (0, import_react77.useContext)(DocsContext2);
  return !href || target === "_blank" || /^https?:\/\//.test(href) ? import_react77.default.createElement(A2, { ...props }) : href.startsWith("#") ? import_react77.default.createElement(AnchorInPage, { hash: href }, children) : import_react77.default.createElement(
    A2,
    {
      href,
      onClick: (event) => {
...
var HeaderWithOcticonAnchor = ({
  ...
  let context = (0, import_react77.useContext)(DocsContext2), OcticonHeader = OcticonHeaders[as], hash = `#${id}`;
  return import_react77.default.createElement(OcticonHeader, { id, ...rest }, import_react77.default.createElement(
    OcticonAnchor,
    {
      "aria-hidden": "true",
      href: hash,
    ...
    import_react77.default.createElement(LinkIcon, null)
  ), children);
};
var HeaderMdx = (props) => {
  let { as, id, children, ...rest } = props;
  if (id)
    return import_react77.default.createElement(HeaderWithOcticonAnchor, { as, id, ...rest }, children);
  let Component4 = as, { as: omittedAs, ...withoutAs } = props;
  return import_react77.default.createElement(Component4, { ...nameSpaceClassNames(withoutAs, as) });
};
var HeadersMdx = SUPPORTED_MDX_HEADERS.reduce(
  (acc, headerType) => ({
    ...acc,
    // @ts-expect-error (Converted from ts-ignore)
    [headerType]: (props) => import_react77.default.createElement(HeaderMdx, { as: headerType, ...props })
  }),
  {}
);
...
var Markdown = withMdxComponentOverride("Markdown", MarkdownImpl);
...
var DescriptionImpl = (props) => {
  let { of } = props;
  if ("of" in props && of === void 0)
    throw new Error("Unexpected `of={undefined}`, did you mistype a CSF file reference?");
  let resolvedOf = useOf(of || "meta"), markdown = getDescriptionFromResolvedOf(resolvedOf);
  return markdown ? import_react75.default.createElement(Markdown, null, markdown) : null;
};
var Description2 = withMdxComponentOverride("Description", DescriptionImpl);
...
var DocsContainer = ({
  ...
  }), import_react79.default.createElement(DocsContext2.Provider, { value: context }, import_react79.default.createElement(SourceContainer, { channel: context.channel }, import_react79.default.createElement(ThemeProvider, { theme: ensure(theme) }, import_react79.default.createElement(
    DocsPageWrapper,
    {
      toc: toc ? import_react79.default.createElement(
        TableOfContents,
        {
...
var BananaSlug = class {
  ...
  * Use the `slug` function to get same slugs.
  ...
  slug(value, maintainCase) {
    let self2 = this, result = slug(value, maintainCase === true), originalSlug = result;
...
var HeadingImpl = ({
  ...
  if (disableAnchor || typeof children != "string")
    return import_react84.default.createElement(H2, null, children);
  let tagID = slugs.slug(children.toLowerCase());
  return import_react84.default.createElement(HeaderMdx, { as: "h2", id: tagID, ...props }, children);
};
var Heading2 = withMdxComponentOverride("Heading", HeadingImpl);
var SubheadingImpl = ({ children, disableAnchor }) => {
  if (disableAnchor || typeof children != "string")
    return import_react83.default.createElement(H3, null, children);
  let tagID = slugs.slug(children.toLowerCase());
  return import_react83.default.createElement(HeaderMdx, { as: "h3", id: tagID }, children);
};
var Subheading = withMdxComponentOverride("Subheading", SubheadingImpl);
var DocsStoryImpl = ({
  of,
  expanded = true,
  ...
  return import_react82.default.createElement(Anchor, { storyId: __primary ? `primary--${story.id}` : story.id }, expanded && import_react82.default.createElement(import_react82.default.Fragment, null, import_react82.default.createElement(Subheading, null, story.name), import_react82.default.createElement(Description2, { of })), import_react82.default.createElement(
    Canvas,
    {
      of,
      withToolbar,
...
var DocsStory = withMdxComponentOverride("DocsStory", DocsStoryImpl);
var PrimaryImpl = () => {
  let primaryStory = usePrimaryStory();
  return primaryStory ? import_react81.default.createElement(DocsStory, { of: primaryStory.moduleExport, expanded: false, __primary: true, withToolbar: true }) : null;
};
var Primary = withMdxComponentOverride("Primary", PrimaryImpl);
...
var StoriesImpl = ({ title = "Stories", includePrimary = true }) => {
  var _a;
  let { componentStories, projectAnnotations, getStoryContext } = (0, import_react85.useContext)(DocsContext2), stories = componentStories(), { stories: { filter } = { filter: void 0 } } = ((_a = projectAnnotations.parameters) == null ? void 0 : _a.docs) || {};
  return filter && (stories = stories.filter((story) => filter(story, getStoryContext(story)))), stories.some((story) => {
    var _a2;
    return (_a2 = story.tags) == null ? void 0 : _a2.includes(Tag.AUTODOCS);
  }) && (stories = stories.filter((story) => {
    var _a2;
    return ((_a2 = story.tags) == null ? void 0 : _a2.includes(Tag.AUTODOCS)) && !story.usesMount;
  })), includePrimary || (stories = stories.slice(1)), !stories || stories.length === 0 ? null : import_react85.default.createElement(import_react85.default.Fragment, null, typeof title == "string" ? import_react85.default.createElement(StyledHeading, null, title) : title, stories.map(
    (story) => story && import_react85.default.createElement(DocsStory, { key: story.id, of: story.moduleExport, expanded: true, __forceInitialArgs: true })
  ));
};
var Stories = withMdxComponentOverride("Stories", StoriesImpl);
...
var SubtitleImpl = (props) => {
  ...
  return content ? import_react86.default.createElement(Subtitle, { className: "sbdocs-subtitle sb-unstyled" }, content) : null;
};
var Subtitle2 = withMdxComponentOverride("Subtitle", SubtitleImpl);
...
var TitleImpl = (props) => {
  ...
  return content ? import_react87.default.createElement(Title, { className: "sbdocs-title sb-unstyled" }, content) : null;
};
var Title3 = withMdxComponentOverride("Title", TitleImpl);
var DocsPage = () => {
  let resolvedOf = useOf("meta", ["meta"]), { stories } = resolvedOf.csfFile, isSingleStory = Object.keys(stories).length === 1;
  return import_react80.default.createElement(import_react80.default.Fragment, null, import_react80.default.createElement(Title3, null), import_react80.default.createElement(Subtitle2, null), import_react80.default.createElement(Description2, { of: "meta" }), isSingleStory ? import_react80.default.createElement(Description2, { of: "story" }) : null, import_react80.default.createElement(Primary, null), import_react80.default.createElement(Controls3, null), isSingleStory ? null : import_react80.default.createElement(Stories, null));
};
function Docs({
  context,
  docsParameter
  ...
  return import_react78.default.createElement(Container2, { context, theme: docsParameter.theme }, import_react78.default.createElement(Page, null));
}
...
function usePreview(projectAnnotations) {
  let previewRef = (0, import_react88.useRef)();
...
function ExternalDocs({
  ...
  return import_react88.default.createElement(Docs, { docsParameter, context: preview2.docsContext() });
}
var preview;
var ExternalDocsContainer = ({ projectAnnotations, children }) => (preview || (preview = new ExternalPreview(projectAnnotations)), import_react89.default.createElement(DocsContext2.Provider, { value: preview.docsContext() }, import_react89.default.createElement(ThemeProvider, { theme: ensure(themes.light) }, children)));
var Meta = ({ of }) => {
  let context = (0, import_react90.useContext)(DocsContext2);
  of && context.referenceMeta(of, true);
  try {
    let primary = context.storyById();
    return import_react90.default.createElement(Anchor, { storyId: primary.id });
  } catch {
    return null;
  }
};
var UnstyledImpl = (props) => import_react91.default.createElement("div", { ...props, className: "sb-unstyled" });
var Unstyled = withMdxComponentOverride("Unstyled", UnstyledImpl);
var WrapperImpl = ({ children }) => import_react92.default.createElement("div", { style: { fontFamily: "sans-serif" } }, children);
var Wrapper9 = withMdxComponentOverride("Wrapper", WrapperImpl);
var PRIMARY_STORY = "^";
...
//# sourceMappingURL=chunk-I5A2M77O.js.map
