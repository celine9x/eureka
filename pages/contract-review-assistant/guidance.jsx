...
<div style={styles.guidanceline} >
  <Checkbox defaultSelected onChange={(checked) => console.log("checkbox", checked)} />
  <Link
    href="#"
...
<div style={{ gap: "var(--spacing-xs)" }}>
    <p style={{ color: "var(--color-content-secondary)", fontSize: "var(--text-body-md)" }}>Additional files for context</p>
<Button variant="secondary" size="sm" iconLeading={<Icon name="ArrowUpTray" size="sm" />}>
  Browse files
</Button>
</div>
